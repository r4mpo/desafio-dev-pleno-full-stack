...
abstract class PadraoService
{
    ...
    protected function montar_resposta($dados, $mensagem_personalizada = null, $mensagem_nao_encontrada): \stdClass
    {
    ...
    protected function definir_dados_resposta($resposta): void
    {
